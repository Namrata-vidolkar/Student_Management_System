...
<div align="center" class="top_panel">
 ...
 <br/> <br/>
  ...
  <tr>
      ...
      <td>
          <input type="gmail" name="sgmail" placeholder="Gmail for search and update" required/>
      </td>
  </tr>
  ...
  <input type="submit" name="edit_stu" class="addbtn"/>
  ...
  <?php 
    ...
    include_once("script/edit_student.php");
